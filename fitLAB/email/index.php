...
<div class="wrapper">
	<div class="r_form_wrap">
		...
		<div class="title">
			<p><?php echo  $row["username"];?> /  E-postanızı Doğrulayın</p>
		</div>
...
<form method="POST" action="dogrulama.php">
				<div class="input_wrap">
					<label for="yourname">E- Mail Adresiniz</label>
					<div class="input_item">
						<span class="icon">
							<ion-icon name="person-sharp"></ion-icon>
						</span>
						<input type="email" name="email" class="input" value="<?php echo  $row["email"];?>" disabled>
					</div>
				</div>
